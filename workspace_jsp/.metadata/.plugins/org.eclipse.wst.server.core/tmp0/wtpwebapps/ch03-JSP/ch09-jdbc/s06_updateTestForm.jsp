...
%>
	<form id="myForm" action="s07_updateTest.jsp" method="post">
		...
		<div class="align-center">
			...
			<input type="button" value="목록" onclick="location.href='s02_selectTest.jsp'">
		</div>
	</form>
<%
		}else{ // num에 잘못된 정보가 들어왔을때
%>
