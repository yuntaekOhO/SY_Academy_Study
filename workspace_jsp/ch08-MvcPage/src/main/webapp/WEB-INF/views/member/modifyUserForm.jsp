		...
		<form id="modify_form" action="modifyUser.do" method="post">
			<ul>
				...
				<li>
					...
					<input type="text" value="${member.phone}" name="phone" id="phone" maxlength="15">
				</li>
				<li>
				...
				<li>
					...
					<input type="text" value="${member.address1}" name="address1" id="address1" maxlength="30">
				</li>
				<li>
					<label for="address2">나머지 주소</label>
					<input type="text" value="${member.address2}" name="address2" id="address2" maxlength="30">
				</li>
			</ul>
