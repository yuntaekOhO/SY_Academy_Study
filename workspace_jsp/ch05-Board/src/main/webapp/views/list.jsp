...
<%
	...
	if(pageNum == null){//list.jsp 최초 호출시
		pageNum = "1";
	}
	
	//한 화면에 몇 개의 글(행,레코드)를 보여줄 것인지 지정
	int rowCount = 10;
	//한 화면에 몇 개의 페이지 수를 보여줄 것인지 지정
	int pageCount = 10;
	...
	int count = dao.getCount();
								   //현재페이지,총 글의개수,보여질 글개수,한화면에 보여질 페이지수, 요청url
